        ...
        <>
                ...
                <div className="overlay">
                    <div className="hero-content">
                        ...
                        <div className="text-content">
                            <h1>Experience the Art of Styling</h1>
                            <p>Premium unisex salon services with a touch of elegance.</p>
                            <Link to="/services">
            ...
            <section className="about-section">
                ...
                <p className="about-description">
                    Founded in 2024,<br />
                    <strong>L &amp; G</strong> is a modern unisex salon offering professional <br />
                    grooming and beauty services. We provide a hygienic,<br />
                    inclusive, and relaxing environment to help clients look and feel their best.
                </p>
                ...
                <div className="about-columns">
                    ...
                    <div className="about-column">
                        <h4>Social Media</h4>
                        <p>📸 Instagram: <a href="https://www.instagram.com/lngsalon/?hl=en" target="_blank" rel="noreferrer">@lgsalon</a></p>
                        <p>📘 Facebook: <a href="https://m.facebook.com/LnGSalon/" target="_blank" rel="noreferrer">LG Beauty Salon</a></p>
                    </div>
                </div>
